module TenorGuitar.Validation (validate, validateJson) where

-- | Validate a TenorGuitar chord pattern when loaded from a JSON file
...
import Serialization.Json (readTenorGuitar)
